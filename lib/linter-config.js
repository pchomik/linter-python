...
class LinterConfig {
    constructor() {
        ...
        this.subs.add(atom.config.observe('linter-python.linuxOnWindows', {}, this.updatePluginConfig));
    ...
    initialPlugin() {
        ...
        this.linuxOnWindows = this.readConfigValue('linuxOnWindows');
        ...
        if (enableDebug) {
            ...
            console.log("[D] >>> Debug prints were enabled.");
        }
        else {
            console.log("[D] >>> Debug prints were disabled.");
            console.log = () => {};
        }
