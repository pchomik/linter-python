...
var MessageParser = (function () {
    ...
    MessageParser.prototype.buildMessage = function (textEditor, result, config) {
        ...
        var text = this.buildErrorText(result);
        var range = util_1.calculateUnderlineRange(line, parseInt(result.row), parseInt(result.col), config);
    ...
    MessageParser.prototype.buildErrorText = function (result) {
        if (!result.tool) {
