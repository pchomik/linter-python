...
module.exports = {
    ...
    config: {
        ...
        enablePep8: {
            type: 'boolean',
            default: false,
            description: 'Enable PEP8 linter'
        },
        enablePep257: {
            type: 'boolean',
            default: false,
            description: 'Enable PEP257 linter',
        },
        enableMcCabe: {
            type: 'boolean',
            default: false,
            description: 'Enable McCabe linter',
        },
        enablePyflakes: {
            type: 'boolean',
            default: false,
            description: 'Enable Pyflakes linter',
        },
        enablePylint: {
            type: 'boolean',
            default: false,
            description: 'Enable Pylint linter. To enable this option please execute following command: pip install pylama-pylint'
        }
    },
    activate() {
